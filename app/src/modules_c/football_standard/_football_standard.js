...
kbmodules.football_standard.upd_player_layout = async function(team){
	...
	btn_pool.prepare_team_layout1.toggle(false)
	btn_pool.prepare_team_layout2.toggle(false)


	$('.layout_buttons_field_ctrl_command').removeClass('prepared_team_layout')
	$(`#layout_buttons_field_ctrl_command${team}`).addClass('prepared_team_layout')
	...
	btn_pool.prepare_team_layout1.toggle(true)
	btn_pool.prepare_team_layout2.toggle(true)
}
