...
window.kbmodules.football_standard._show_field_layout = async function(team){
	const tgt_lineup = window.kbmodules.football_standard.resource_index.side?.[str(team).lower()]?.lineup;
	...
	// await window.kbmodules.football_standard.wipe_player_list_from_title()
...
//        Commenter stuff
// ================================
window.kbmodules.football_standard.save_commenter = function(){
	ksys.context.module.prm('todays_commenter', $('#commenter_name_input')[0].value)
}

window.kbmodules.football_standard.show_commenter = async function(){
...
window.kbmodules.football_standard.hide_commenter = async function(){
	ksys.btns.pool.show_commenter.toggle(false)
	await window.kbmodules.football_standard.titles.commenter.overlay_out()
	ksys.btns.pool.show_commenter.toggle(true)
}
...
window.kbmodules.football_standard.exec_substitute = async function(subs_type){
	...
	if (window.kbmodules.football_standard.title_schema_switch.selected == 'separate'){
		const title = window.kbmodules.football_standard.titles.replacement_seq;
...
window.kbmodules.football_standard.extra_time_vis = async function(state){
	...
	if (state == false){
		await window.kbmodules.football_standard.titles.timer.set_shape_color('main_time_bg', 'D80D83');
...
window.kbmodules.football_standard.timer_fset.builtin.timer_callback = function(tick){
...
window.kbmodules.football_standard.timer_fset.builtin.resume_main_timer_from_offset = function(event){
...
window.kbmodules.football_standard.timer_fset.builtin.extra_timer_callback = function(tick){
	const minutes = Math.floor(tick.global / 60)
	const seconds = tick.global - (60*minutes)
...
window.kbmodules.football_standard.timer_fset.builtin.stop_extra_time = function(){
	window.kbmodules.football_standard?.extra_counter?.force_kill?.()
	window.kbmodules.football_standard.extra_counter = null;
}
...
window.kbmodules.football_standard.add_score_from_cards_panel = async function(){
	...
	if (window.kbmodules.football_standard.title_schema_switch == 'separate'){
		// Set logo
