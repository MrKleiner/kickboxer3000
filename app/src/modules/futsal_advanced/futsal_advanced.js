...
$this.show_coach = async function(side){
	...
	ksys.btns.adv_timeout({
		'show_coach_home_team': $this.titles.coach.anim_durations[null],
		'show_coach_guest_team': $this.titles.coach.anim_durations[null],

		'hide_coach_home_team': $this.titles.coach.anim_durations[null],
		'hide_coach_guest_team': $this.titles.coach.anim_durations[null],
	})
...
$this.hide_coach = async function(){
	ksys.btns.adv_timeout({
		'show_coach_home_team': $this.titles.coach.anim_durations['TransitionOut'],
		'show_coach_guest_team': $this.titles.coach.anim_durations['TransitionOut'],

		'hide_coach_home_team': $this.titles.coach.anim_durations['TransitionOut'],
		'hide_coach_guest_team': $this.titles.coach.anim_durations['TransitionOut'],
	})
...
$this.timeout_vis = async function(state){
	if (state == true){
		ksys.btns.adv_timeout({
			'show_timeout_title': $this.titles.timeout.anim_durations[null],
	...
	if (state == false){
		ksys.btns.adv_timeout({
			...
			'show_timeout_title': $this.titles.timeout.anim_durations['TransitionOut'],
		})
